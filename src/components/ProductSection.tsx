  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      target: [
        ...
        '③ 여신심사 — ①과 ② 모두 해당하는 분을 대상으로 서민금융진흥원 심의 규정에 따른 심사를 거쳐 승인 여부가 결정됩니다.'
      ],
      suitability: [
              ...
              <div className="block bg-gradient-to-tr from-teal-600 to-emerald-600 p-6 md:p-8 rounded-3xl text-white shadow-lg shadow-teal-100 space-y-4">
                ...
                <div className="pt-2">
                  <p className="text-xs text-teal-100 leading-normal">
                    ※ 이 상품은 서민금융진흥원 심의 규정에 따른 심사를 거쳐 승인 여부가 결정되며, 필요 서류와 심사 기준은 상담을 통해 확인할 수 있습니다. 연체 시 최고 연 9%의 지연배상율이 적용될 수 있으며(서민금융진흥원 고시 기준), 상환능력에 비해 대출금이 과도할 경우 신용도 하락 등 부담이 커질 수 있으니 상환 계획을 충분히 검토한 후 신청하시기 바랍니다.
                  </p>
                </div>
              </div>
