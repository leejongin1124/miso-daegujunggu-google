...
export default function ProductSection({ onScrollToSection, onOpenCalculator, initialTab, hideTabs, onTabChange }: ProductSectionProps) {
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      repaymentMethod: '매월 원리금 균등분할 상환',
      target: [
        '① 기본 대상 확인 (다음 중 하나 해당) — 개인신용평점 하위 20% 이하 (KCB 700점 이하 · NICE 749점 이하, 2026년 기준) 또는 하위 50% 이하 & 연소득 3,500만원 이하 / 기초생활수급자 또는 차상위계층 / 근로장려금 신청자격 대상자',
        '② 추가 요건 중 하나 확인 (성실상환) — 불법사금융예방대출 완제자 또는 미소금융 12회차 이상 성실상환자',
        '② 추가 요건 중 하나 확인 (사회적배려대상자) — 한부모·조손·다문화가족, 북한이탈주민, 등록장애인, 국민기초생활수급자, 차상위계층, 자활근로자, 근로장려금 수급자',
        '② 추가 요건 중 하나 확인 (특별취약계층) — 불법사금융 피해자 / 보이스피싱 피해자 / 전세사기 피해자 / 특별재난지역 거주자',
        '③ 여신심사 — ①과 ② 모두 해당하는 분을 대상으로 서민금융진흥원 심의 규정에 따른 심사를 거쳐 지원 여부가 결정됩니다.'
      ],
      suitability: [
              ...
              <div className="block bg-gradient-to-tr from-teal-600 to-emerald-600 p-6 md:p-8 rounded-3xl text-white shadow-lg shadow-teal-100 space-y-4">
                ...
                <div className="pt-2">
                  <p className="text-xs text-teal-100 leading-normal">
                    ※ 이 상품은 서민금융진흥원 심의 규정에 따른 심사를 거쳐 지원 여부가 결정되며, 필요 서류와 심사 기준은 상담을 통해 확인할 수 있습니다. 연체 시 최고 연 9%의 지연배상율이 적용될 수 있으며(서민금융진흥원 고시 기준), 상환능력에 비해 대출금이 과도할 경우 신용도 하락 등 부담이 커질 수 있으니 상환 계획을 충분히 검토한 후 신청하시기 바랍니다.
                  </p>
                </div>
              </div>
