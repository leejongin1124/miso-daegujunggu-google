    ...
    <footer className="bg-slate-900 text-slate-400 py-10 border-t border-slate-800 text-left">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="flex items-center space-x-2.5 pb-6 border-b border-slate-800">
          ...
          <div>
            <div className="text-white font-bold text-lg tracking-tight leading-none">(사)미소금융대구중구법인</div>
            <div className="text-[11px] font-semibold text-slate-400 tracking-wider uppercase mt-0.5">서민금융진흥원 공식 사업수행기관</div>
          </div>
        </div>

        {/* 법인 정보 */}
        <div className="text-xs leading-relaxed space-y-3">
          <div className="flex flex-wrap gap-x-6 gap-y-1.5 text-slate-400 font-semibold">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-1.5 text-slate-500 font-medium">
