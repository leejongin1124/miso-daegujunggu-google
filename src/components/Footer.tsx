  ...
  return (
    <footer className="bg-slate-900 text-slate-400 py-10 border-t border-slate-800 text-left">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-1">
        ...
        <Link
          to="/"
          className="flex items-center space-x-2.5 pb-1.5 border-b border-slate-800 cursor-pointer hover:opacity-80 transition-opacity w-fit text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded"
