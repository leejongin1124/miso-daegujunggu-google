...
const ARTICLES = [
  ...
  },
  {
    ...
    note: '※ 정확한 보유기간은 상품·서류 유형에 따라 상이할 수 있으며, 법인 내부 규정 확인 후 갱신될 예정입니다.',
  },
  {
  ...
  },
  {
    ...
    note: '※ 담당 부서 및 실무 연락처가 별도로 있는 경우, 법인 확인 후 갱신 예정입니다.',
  },
  {
    title: '제8조 (권익침해 구제방법)',
    body: [
