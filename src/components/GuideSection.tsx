  ...
  const faqs = [
    {
      ...
      answer: "개인신용평점 하위 20%(KCB 700점 이하, NICE 749점 이하, 2026년 기준)에 해당하시거나, 기초생활수급자 및 차상위계층, 혹은 근로장려금 신청자격 요건에 해당하는 소상공인, 자영업자 분들이 주요 지원 대상입니다. 담보나 보증 없이 순수 신용과 자활 의지로 지원하기 때문에 기준에 해당하시면 적극 검토해 드립니다."
    },
    {
      id: 2,
