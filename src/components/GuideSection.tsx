          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 space-y-3">
            ...
            <div className="bg-sky-50 border border-sky-200 rounded-xl p-4 flex items-start gap-2.5">
              ...
              <ul className="text-sm font-semibold text-sky-900 space-y-1.5 break-keep">
                ...
                <li>행정복지센터, 신용회복위원회, 미소금융 지점을 방문하지 않고 은행만 방문하시면 가입이 가능합니다.</li>
            ...
            <ol className="text-sm text-slate-600 space-y-1 list-decimal list-inside">
              <li>추천서 발급 (미소금융 지점 방문, 지원대상 확인서류 지참, 신청서 작성)</li>
              <li>적금통장 개설 (은행 지점 방문, 추천서 지참)</li>
              <li>약정체결 (미소금융 지점 방문, 지원금 지급 관련 거래약정서 작성)</li>
              <li>적금 만기 시 청구 (미소금융 지점 방문, 해지 이자 영수증 지참)</li>
              <li>지원금 지급 (서민금융진흥원이 계좌로 송금)</li>
            </ol>
          </div>
