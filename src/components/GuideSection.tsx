  ...
  const faqs = [
    {
      ...
      answer: "개인신용평점 하위 20%(KCB 700점 이하, NICE 749점 이하, 2026년 기준)에 해당하시거나, 기초생활수급자 및 차상위계층, 혹은 근로장려금 신청자격 요건에 해당하는 청년, 소상공인, 자영업자 분들이 주요 지원 대상입니다. 담보나 보증 없이 순수 신용과 자활 의지로 지원하기 때문에 기준에 해당하시면 적극 검토해 드립니다."
    },
    {
      id: 2,
      question: "대출 금리가 정말 고정 연 4.5% 수준인가요? 추가 수수료는 없나요?",
      answer: "상품별 금리와 우대금리 적용 여부는 대출 종류, 대상 요건, 성실상환 여부, 심사 결과에 따라 달라질 수 있습니다. 미소금융 정책자금은 중개 수수료, 보증 선납금 등 별도 수수료를 요구하지 않습니다. 금리와 상환 조건은 상담 시 반드시 개별 확인하시기 바랍니다. 취급·중개 수수료 등 명목으로 금전을 요구하는 연락을 받으시면 즉시 대표번호(053-252-6408)로 신고해 주시기 바랍니다."
    },
    {
      id: 3,
    ...
    },
    {
      ...
      answer: "방문 상담(053-252-6408) → 서류 제출 → 담당 위원 현장 방문 → 융자위원회 심의 순서로 진행됩니다. 통상 7영업일 이내이며, 서류 보완·심사 일정에 따라 달라질 수 있습니다. 필요 서류를 미리 준비해 오시면 더 빠르게 처리됩니다."
    },
    {
      id: 5,
