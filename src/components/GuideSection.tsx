...
export default function GuideSection({ sectionId }: { sectionId?: string }) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "기본금리는 연 4.5%예요. 그동안 연체 없이 잘 갚아오신 분은 성실상환 우대금리가 적용돼서 연 3.5%로 낮아집니다. 반대로 상환이 늦어지면 단기연체 시 연 5.5%가 적용되고, 장기연체로 넘어가면 지연배상금률로 연 9.0%까지 올라가니 상환일은 꼭 지켜주세요. 무등록사업자는 이런 구분 없이 처음부터 연 2.0%의 낮은 금리가 적용됩니다."
    }
  ];
