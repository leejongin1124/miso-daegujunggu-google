  ...
  const faqs = [
    {
      ...
      answer: "개인신용평점 하위 20%(KCB 700점 이하, NICE 749점 이하 기준)에 해당하거나 기초생활수급자, 차상위계층, 근로장려금 신청자격 요건에 해당하는 청년, 소상공인, 자영업자가 신청할 수 있습니다. 요건 충족이 곧 승인을 의미하지는 않으며, 최종 지원 여부는 여신심사 결과에 따라 결정됩니다."
    },
    {
      id: 2,
    ...
    },
    {
      ...
      answer: "횟수 자체에 제한은 없습니다. 기존 대출을 완제(만기 또는 중도상환)한 뒤 신청 자격을 다시 충족하면 재신청할 수 있으며, 최종 여부는 심사 결과에 따라 결정됩니다."
    },
    {
      id: 14,
