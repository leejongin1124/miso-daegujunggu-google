...
export default function GuideSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "법원 개인회생 면책 결정을 받았거나 신용회복위원회의 채무조정을 진행하고 계시더라도, 성실 변제 상환 기간(통상 12회 또는 1년 이상 납입) 요건을 충족하셨고 현재 연체 중인 건이 없다면 경영개선 자금 등의 심사 신청이 가능합니다. 개별적인 조정 상태와 납입 이력 증빙에 따라 구체적으로 판단되므로 방문 상담을 추천드립니다."
    },
    {
      id: 6,
