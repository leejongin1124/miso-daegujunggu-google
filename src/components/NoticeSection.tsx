  ...
  const notices = [
    {
      id: 1,
      badge: '공지',
      title: '신중년 자원봉사단 경영 상담 지원 사업 시작',
      date: '2026-05-12',
      desc: '대구광역시와 함께 경험 많은 신중년 자원봉사자들이 대구 지역 영세자영업자와 청년을 대상으로 경영 상담과 자립 지원을 도와드립니다.'
    },
    {
      id: 2,
      badge: '중요',
      title: '불법 대출 중개 및 사칭 피해 예방 안내',
      date: '2026-04-18',
      desc: '(사)미소금융대구중구법인은 대출 중개 수수료나 선납금을 요구하지 않습니다. 저희 법인을 사칭하여 금품을 요구하는 연락을 받으신 경우, 절대 응하지 마시고 금융감독원(1332)에 신고해 주시기 바랍니다.'
    },
  ];
