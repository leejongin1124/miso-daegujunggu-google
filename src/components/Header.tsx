        ...
        <div className="flex justify-between items-center h-14">
          ...
          <div className="flex items-center space-x-2 cursor-pointer min-w-0 flex-shrink" onClick={() => handleSublinkClick('hero-section', TabType.ABOUT)}>
            ...
            <div className="text-left min-w-0 leading-none">
              ...
              <span className="text-[8px] sm:text-[9px] lg:text-[10px] font-semibold text-slate-400 tracking-none tracking-wider uppercase block whitespace-nowrap mt-0.5">서민금융진흥원 공식 사업수행기관</span>
            </div>
          </div>
