...
import { Menu, X, ChevronDown, Phone, User, Clock, Network, MapPin, Info, Users, Briefcase, Rocket, Shield, Target, HelpCircle, Calculator, FileText, Award, Store, Zap, Heart, Bell, AlertTriangle, PiggyBank } from 'lucide-react';
  ...
  const menuItems = [
    ...
    },
    {
      ...
      sublinks: [
        ...
        { name: '청년미래이음', id: 'youth-fund', icon: Rocket, color: 'text-purple-500' },
    ...
    },
    {
      ...
      sublinks: [
        ...
        { name: '미소드림적금', id: 'miso-dream-savings', icon: PiggyBank, color: 'text-pink-500' }
      ]
    },
    {
      type: TabType.CASES,
