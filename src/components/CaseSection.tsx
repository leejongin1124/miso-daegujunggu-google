...
export default function CaseSection({ initialFilter, onFilterChange }: CaseSectionProps) {
  ...
  const cases: CaseStudy[] = [
    ...
    },
    {
      ...
      title: '12개월 성실 상환 후, 추가 생계자금으로 살림과 장사 두 마리 토끼를 잡았습니다',
      problem: '미소금융 생계자금을 받아 1년 넘게 밀리지 않고 갚아왔는데, 갑자기 부모님 병원비와 가게 운영비가 겹쳐서 다시 급전이 필요해졌습니다. 이미 대출이 있는데 또 받을 수 있을지 걱정이 앞섰습니다.',
