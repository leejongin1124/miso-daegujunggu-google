...
export default function CaseSection({ initialFilter }: CaseSectionProps) {
  ...
  const cases: CaseStudy[] = [
    ...
    },
    {
      ...
      effect: '6년이라는 긴 거치 기간 덕분에 초기 부채 부담 없이 브랜드 준비에 전념할 수 있었고, 마침내 독립할 수 있었습니다.',
    ...
    },
    {
      ...
      effect: '면접 복장 마련과 토익 응시료 부담을 덜고, 지역의 우량 중견기업에 최종 합격해 성실히 상환하고 있습니다.',
      author: '김○○ 사원 (20대 취업인)',
      location: '대구 남구'
    },
    {
      ...
      effect: '아이는 무사히 퇴원해 학교에 다니고 있으며, 연 4.5% 수준(월 1만원 미만 이자)의 부담으로 힘든 시기를 넘길 수 있었습니다.',
