          ...
          <div className="lg:col-span-8 text-left space-y-6">
            ...
            <div className="text-slate-600 text-base md:text-lg leading-relaxed space-y-4 break-keep">
              ...
              <p className="font-semibold text-slate-800">
                또한 사회적기업이나 사회적협동조합에 대한 사회적금융의 확대를 통해 지역경제 활성화와 지속가능한 공동체 발전에도 동참하고, 나아가 구성원 모두가 금융기관에서 오랜 기간 쌓은 금융경력을 사회에 환원하는 봉사정신으로 미소금융을 이용하시는 분들과 따뜻한 동반자가 되는 데 최선을 다하겠습니다.
              </p>
            </div>
