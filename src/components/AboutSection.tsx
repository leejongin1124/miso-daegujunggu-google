  ...
  const historyData: { year: string; items: HistoryItem[] }[] = [
    {
      ...
      items: [
        ...
        { date: '07.31', text: '사회연대금융 누적 대출금액 15억 원 돌파 (대출건수 40건)', category: '지원성과', emphasis: false },
        { date: '07.15', text: '미소금융 누적 대출금액 600억 원 돌파 (대출건수 6,200건)', category: '지원성과', emphasis: true },
        { date: '04.28', text: '2025년 미소금융 사업실적 평가 우수등급 표창(서민금융진흥원장)', category: '수상', emphasis: true }
      ]
    },
    {
      year: '2025',
      items: [
        ...
        { date: '07.01', text: '대구신용보증재단 남지점과 서민금융 지원 연계협약 체결(하나은행 1층·신용보증재단 3층·미소금융 4층 입주)', category: '협약', emphasis: false }
      ]
    },
    {
      year: '2024',
    ...
    },
    {
      ...
      items: [
        ...
        { date: '03.19', text: '대구광역시 코로나 특별재난지역 선포에 따른 직장인 대상 미소금융특별자금 대출 실시', category: '지원성과', emphasis: true, newsUrl: 'https://biz.chosun.com/site/data/html_dir/2020/04/29/2020042901566.html' }
      ]
    },
    {
      year: '2019',
    ...
    },
    {
      ...
      items: [
        ...
        { date: '08.22', text: '서민금융진흥원장 표창장(누적대출 200억 원·2,000건 달성 클럽)', category: '수상', emphasis: false },
        { date: '06.28', text: <>법인 명칭 변경 (대구중구<u className="underline decoration-2">지점</u> → 대구중구<u className="underline decoration-2">법인</u>) 및 사업내용(사회적금융) 추가</>, category: '기관운영', emphasis: false },
    ...
    },
    {
      year: '2013',
      items: [
        { date: '10.18', text: '사회적기업 한마음체육대회 참가 및 지역사회 네트워크 구축', category: '지원성과', emphasis: false, newsUrl: 'https://ksen.co.kr/mobile/article.html?no=3852' },
        { date: '06.21', text: '미소금융 지역법인 대표자 회의 개최 (전국 최초 행사)', category: '기관운영', emphasis: false },
        { date: '06.06', text: '사무소 이전 (대구광역시 중구 경상감영길 제일은행 대구지점 4층)', category: '기관운영', emphasis: false },
        ...
        { date: '01.17', text: '2012년도 미소금융 사업실적 평가 최우수등급 표창(미소금융중앙재단)', category: '수상', emphasis: false }
      ]
    },
    {
      year: '2012',
    ...
    },
    {
      year: '2010',
      items: [
        { date: '05.28', text: '법인 개점(대구광역시 정무부시장 참석) 및 영업 개시', category: '설립', emphasis: true, newsUrl: 'https://www.fntimes.com/html/view.php?ud=20100530194522102969_18' },
        { date: '05.06', text: '사단법인 미소금융대구중구법인 설립 등기 완료(대구지방법원)', category: '설립', emphasis: false },
        { date: '04.28', text: '사무소 무상 임차 (대구광역시 중구 서문로 갑을빌딩 2층)', category: '설립', emphasis: false },
        ...
        {show(['ceo-greeting', 'about-miso']) && <div id="ceo-greeting" className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center bg-slate-50 p-8 md:p-14 rounded-3xl border border-slate-100">
          ...
          <div className="lg:col-span-8 text-left space-y-6">
            ...
            <div className="text-slate-600 text-base md:text-lg leading-relaxed space-y-4 break-keep">
              ...
              <p>
                미소금융은 저소득·저신용으로 제도권 금융을 이용하기 어려운 금융취약계층의 자립을 도와주기 위해 만들어진 대표적 정책서민금융이며,<br className="sm:hidden" /> 우리 법인은 금융위원회의 허가를 받아 설립된 비영리 공익법인 및 미소금융 사업수행기관으로서 금융의 사회안전망 역할을 수행하고 있습니다.
              </p>
              <p>
                따라서 금융사각지대에 놓인 노점상이나 영세자영업자 중심의 지원대상자를 적극 발굴하여 적기의 자금 지원과 더불어,<br className="sm:hidden" /> 일시적 어려움으로 절박한 상황에 놓인 청년과 취약계층에게도 희망을 주는 포용적 금융을 실천하기 위해 노력하겠습니다.
              </p>
              <p>
                또한 사회적기업이나 사회적협동조합에 대한 사회적금융의 확대를 통해 지역경제 활성화와 지속가능한 공동체 발전에도 동참하고,<br className="sm:hidden" /> 나아가 구성원 모두가 금융기관에서 오랜 기간 쌓은 금융경험을 사회에 환원하는 봉사정신으로 미소금융을 이용하시는 분들과 따뜻한 동반자가 되는 데 최선을 다하겠습니다.
              </p>
            </div>

            <p className="text-right text-slate-800 font-extrabold text-base pt-4 decoration-teal-600 decoration-2">
              사단법인 미소금융 대구중구법인<br />
              CEO <span className="text-teal-600 font-black text-lg">김 석 동</span><br />
              <span className="text-slate-500 font-semibold text-xs tracking-wide">Daegujunggu Miso Microcredit Foundation</span>
            </p>
          </div>
        </div>}
